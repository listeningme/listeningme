...
<body>
	...
	<div id="switcher">
		<div class="logos">
			<a href="http://kopyov.com" class="logo"><img src="selector/logo.png" alt="" /></a>
		...
		<ul class="menu">																									
			...
			<li class="purchase" rel="http://themeforest.net/item/pannonia-fully-responsive-admin-template/4360373?ref=kopyov"><a href="http://themeforest.net/item/pannonia-fully-responsive-admin-template/4360373?ref=kopyov"><b></b><span>Purchase</span></a></li>		
			<li class="remove_frame" rel="http://demo.kopyov.com/pannonia"><a href="http://demo.kopyov.com/pannonia"></a></li>		
		</ul>
	</div>
		
	<iframe id="iframe" src="http://demo.kopyov.com/pannonia" frameborder="0" width="100%"></iframe>
